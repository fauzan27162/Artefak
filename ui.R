...
dashboardPage(
  ...
  dashboardHeader(
    ...
    title = span(style = "font-family: 'Helvetica';", 
                 "Dashboard Asosiasi Polusi Udara dengan Kematian Bayi & Pneumonia Balita"),
    # Dropdown items
    ...
    tags$li(class = "dropdown", tags$a(href = "https://git.stis.ac.id/222112212/artefak_skripsi_shiny.git", icon("github"), "Source Code", target = "_blank"))
  ),
  dashboardSidebar(
